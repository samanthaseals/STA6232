...
- Today we will again be examining [US House election results](https://github.com/rfordatascience/tidytuesday/blob/master/data/2023/2023-11-07/readme.md) from 1976-2022, distributed by Tidy Tuesday.
...
$$ 
\begin{align*}
\ln(\hat{y}) =& 16.11 - 0.03 \text{ year} - 6.22 \text{ repub.} + 0.03 \text{ midwest} + 0.09 \text{ northeast} + 0.07 \text{ west}  \\
